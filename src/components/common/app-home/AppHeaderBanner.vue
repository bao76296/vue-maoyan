<template>
    <div class="nav">
        <div class="header-box">
            ...
            <div class="mine-img">
                <img class="my-img" src="https://i1.hdslb.com/bfs/face/f976cfbdfc9b63567149a25459525b289f47bd1e.jpg@53w_53h.webp" alt="">
            </div>
            <div class="donwload">
                <p class="donwload-btn">下载 App</p>
            </div>
        </div>
    </div>
</template>
    ...
    .nav {
        .header-box{
            ...
            .seach{
                ...
                margin : 0  0.5867rem 0 3.2004rem;
            }
